...
public class DeliveryAPIRestTemplateUtil extends RestOperationImpl implements IRestTemplate {

	private static Logger logger = LoggerFactory.getLogger(DeliveryAPIRestTemplateUtil.class);
	
	public DeliveryAPIRestTemplateUtil(RestOperations restOperation, String host, String prot) {
